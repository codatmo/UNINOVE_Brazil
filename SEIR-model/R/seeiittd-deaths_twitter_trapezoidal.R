...
stan_data_sim$n_rho_twitter_symptons_pieces <- stan_data_sim$n_rho_calls_111_pieces
stan_data_sim$n_rho_calls_111_pieces <- NULL
stan_data_sim$rho_twitter_symptons_left_t <- stan_data_sim$rho_calls_111_left_t
stan_data_sim$rho_twitter_symptons_right_t <- stan_data_sim$rho_calls_111_right_t
stan_data_sim$rho_calls_111_left_t <- NULL
stan_data_sim$rho_calls_111_right_t <- NULL
stan_data_sim$twitter_symptons_length <- stan_data_sim$calls_111_length
stan_data_sim$calls_111_length <- NULL
stan_data_sim$twitter_symptons_start <- stan_data_sim$calls_111_start
stan_data_sim$calls_111_start <- NULL
stan_data_sim$twitter_symptons <- stan_data_sim$calls_111
stan_data_sim$calls_111 <- NULL

# Trapeizodal Rule Model
model <- cmdstan_model(here::here("SEIR-model", "stan", "deaths_twitter_trapezoidal.stan"))
